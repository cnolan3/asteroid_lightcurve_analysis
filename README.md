...
| ZTF / Gaia DR3 _(planned, Unit 24)_                   | Real-world sparse test sets                        | Wide-survey sparse photometry                                                             |
...
curve, giving **~20,500 labeled asteroids**. Truly _dense_ curves suitable as
...
3. **Feature extraction + supervised classifier**: turn each sparse curve and its
   ...
   Lomb–Scargle period is correct.
...
A notable finding: raw peak power alone is _worse than random_ (0.406), because
...
- Richer models: gradient-boosted trees and a CNN on the periodogram / phase-folded
  representation.
- A candidate-ranking framing that can _recover_ periods Lomb–Scargle misses, not
